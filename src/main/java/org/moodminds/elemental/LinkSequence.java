...
public class LinkSequence<E> extends AbstractLinkSequence<E, Link<E>> {
    ...
    public LinkSequence(E... elements) {
        this(producer(elements), new Tails<>());
    }
     ...
     */
    protected LinkSequence(Producer<? extends E> elements, Function<Link<E>, Link<E>> tailing) {
        super(elements, Link::new, tailing);
    }
    ...
    /**
     * A stateful function that maintains and returns the previously registered tail link.
     * <p>
     * Each invocation of {@link #apply(Link)} returns the current tail and updates it
     * to the provided {@code link}, allowing incremental construction of a linked sequence.
     *
     * @param <E> the type of elements stored in the links
     */
    protected static class Tails<E> implements Function<Link<E>, Link<E>> {
