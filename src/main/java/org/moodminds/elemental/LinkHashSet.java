...
/**
 * A {@link LinkedHashMap}-powered implementation of the {@link Set} interface.
 * <p>
...
public class LinkHashSet<E> extends HashSet<E> {
    ...
    public LinkHashSet(int initialCapacity) {
        this(new LinkedHashMap<>(initialCapacity), Stream.empty());
    }
    ...
    public LinkHashSet(int initialCapacity, float loadFactor) {
        this(new LinkedHashMap<>(initialCapacity, loadFactor), Stream.empty());
    }
