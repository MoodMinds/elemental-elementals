 ...
 */
public class HashSet<E> extends AbstractSet<E, Map<E, Object>> implements RandomMatch {
     ...
     * @param elements the given elements {@link Stream}
     */
    protected HashSet(HashMap<E, Object> map, Stream<? extends E> elements) {
        super(map); elements.forEach(this::add);
    }
