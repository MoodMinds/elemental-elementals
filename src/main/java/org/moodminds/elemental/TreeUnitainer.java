...
public class TreeUnitainer<E> extends AbstractNavigableUnitainer<E, NavigableMap<E, E>>
     ...
     */
    @SafeVarargs
    public static <E extends Comparable<E>> TreeUnitainer<E> container(E... elements) {
     ...
     */
    @SafeVarargs
    public static <E> TreeUnitainer<E> container(Comparator<? super E> comparator, E... elements) {
