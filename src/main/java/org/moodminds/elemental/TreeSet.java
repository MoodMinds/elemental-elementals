...
public class TreeSet<E> extends AbstractNavigableSet<E, NavigableMap<E, E>> {
    ...
    public TreeSet(Comparator<? super E> comparator, E... elements) {
        this(comparator, producer(elements));
    }
     ...
     */
    public TreeSet(Producer<? extends E> elements) {
        this(new TreeMap<>(), elements);
    }

    /**
     * Construct the object with the given {@link Comparator}
     ...
     * @throws NullPointerException if {@code elements} is {@code null}
     */
    public TreeSet(Comparator<? super E> comparator, Producer<? extends E> elements) {
     ...
     */
    protected TreeSet(NavigableMap<E, E> map) {
        super(map);
    }
