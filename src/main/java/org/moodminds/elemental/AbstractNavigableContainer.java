...
public abstract class AbstractNavigableContainer<E,
            N extends AbstractNavigableContainer.Node<E, N>,
            B extends AbstractNavigableContainer.Bucket<E, N, B>,
    ...
    @Override public Iterator<E> lowerAll(E e) {
        return ofNullable(map.lowerEntry(e)).map(Map.Entry::getValue)
                .map(value -> isBucket(value) ? iterator(asBucket(value)) : iterator(value, true))
