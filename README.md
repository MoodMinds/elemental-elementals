...
Provided direct **Container** and **Collection** implementations, such as **HashContainer**
and **HashCollection**, **TreeContainer** and **TreeCollection** as **NavigableContainer** and handling duplicate
